...
const offerings = [
  ...
  { title: "Garage cleanouts", body: "Clear the overflow and put your garage back to work.", image: "/images/service-story/unsplash-garage-storage.jpg", alt: "A garage filled with boxes, tools, equipment, and household clutter", href: "/services/residential/garage-cleanout" },
  ...
  { title: "Office cleanouts", body: "Clear office furniture and equipment for a move, refresh, or new tenant.", image: "/images/service-story/unsplash-office-boxes.jpg", alt: "Stacked moving boxes, office storage, and equipment ready for removal", href: "/services/commercial/office-cleanout" },
  { title: "Construction debris", body: "Keep your next project moving by getting leftover materials out of the way.", image: "/images/items/renovation-debris.webp", alt: "A pile of drywall, wood, and brick construction debris", href: "/services/commercial/construction-debris" },
];
...
export default function Home() {
  return <main className="clearway-home">
    <section className="cw-hero" id="top">
      ...
      <div className="cw-hero-content"><h1>SAME-DAY<br />JUNK<br />REMOVAL</h1><p>Junk removal for a cleaner, brighter Chicagoland.</p><a className="cw-lime-button" href="#book">Choose your pickup time <IconArrowRight aria-hidden="true" /></a><div className="cw-assurances" aria-label="Clearway service benefits"><span><IconLeaf aria-hidden="true" />Reliable crews</span><span><IconShieldCheck aria-hidden="true" />Responsible disposal</span><span><IconHeart aria-hidden="true" />A cleaner, happier community</span></div></div>
    </section>
